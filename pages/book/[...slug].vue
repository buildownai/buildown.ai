    ...
    <LandingContainer>
        <main class="pt-8 pb-16 lg:pt-16 lg:pb-24 antialiased">
            <div class="flex gap-x-5">
                <LandingAside v-if="hasPage" class="min-w-56"></LandingAside>
                <article
                    class="flex-grow format format-sm sm:format-base lg:format-lg format-blue prose-base"
                >
                    <ContentDoc :path="$route.path">
                        <template v-slot="{ doc }">
                            <h1
                                class="text-center text-4xl lg:text-5xl font-bold lg:tracking-tight"
                            >
                                {{ doc.title }}
                            </h1>
                    ...
                    <LandingLink
                        ...
                        size="lg"
                        styleName="muted"
                        class="block text-nowrap m-auto mt-20"
                        :href="nextPage._path"
                        >{{ nextPage.title }}
